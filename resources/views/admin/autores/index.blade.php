...
<titulo titulo="Lista de Autores" v-bind:breadcrumbs="{{$listaBreadcrumbs}}">
    ...
    <div class="form-group">
      ...
      <div class="col-md-12 m-b-20">
          ...
          <select class="form-control" name="autor" id="autor">
            ...
            <option value="S" {{(old('autor') && old('autor') == 'S' || !old('autor') ? 'selected' : '')}}>Sim</option>
          </select>
      </div>
      <div class="col-md-12 m-b-20">
...
<modal idmodal="modalEditar" titulo="Editar item">
  <formulario id="formEditar" css="form-horizontal form-material" v-bind:action="'/admin/autores/'+$store.state.item.id" method="put" enctype="" token="{{csrf_token()}}">
    <div class="form-group">
      <div class="col-md-12 m-b-20">
