...
class Artigo extends Model
{
    ...
    protected $fillable = ['titulo','descricao','data','conteudo'];
    ...
    public static function listaArtigos(){
      ...
      if($user->admin == "S"){
        $listaArtigos = DB::table('artigos')
                      ...
                      ->select('artigos.id','artigos.titulo','users.name','artigos.data')
    ...
    public static function listaArtigosSite($busca = null){
